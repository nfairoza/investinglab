      ...
      {!isLoading && s && (
        <div className="mt-4 space-y-4">
          <div className="flex items-baseline gap-3">
            ...
            <span className={`rounded-md border border-hairline px-2 py-0.5 text-sm ${tone(s.overall)}`}>{s.label}</span>
          </div>
          ...
          {/* guides */}
          <div className="grid grid-cols-1 gap-x-6 gap-y-1 border-t border-hairline pt-3 text-sm sm:grid-cols-2">
